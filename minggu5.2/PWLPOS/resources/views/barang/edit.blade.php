             ...
             @else
                 <form method="POST" action="{{ url('/barang/' . $barang->barang_id) }}" class="form-horizontal">
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-11">
                             <input type="text" class="form-control" id="kode_barang" name="barang_kode"
                                 value="{{ old('barang_kode', $barang->kode_barang) }}" required>
                             @error('barang_kode')
                                 <small class="form-text text-danger">{{ $message }}</small>
                             @enderror
                         </div>
                     ...
                     <div class="form-group row">
                         ...
                         <div class="col-11">
                             <input type="text" class="form-control" id="nama_barang" name="barang_nama"
                                 value="{{ old('barang_nama', $barang->nama_barang) }}" required>
                             @error('barang_nama')
                                 <small class="form-text text-danger">{{ $message }}</small>
                             @enderror
                         </div>
